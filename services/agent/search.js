...
function service(data) {
    ...
    .fcall( () => {
        ...
        return [models.agent.findAndCountAll({
            raw: true,
            limit,
            offset,
            where: query_where,
    ...
    .spread( (agents, params) => {

        let response = agents.rows.map(normalize)
        ...
        d.resolve(paginate(response, 'agents', agents.count, limit, page));
    })
    .catch( e => {
