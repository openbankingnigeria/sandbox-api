...
var spec = morx.spec({})  
                ...
                .build('updateData', 'required:true') 
                .build('updateCondition', 'required:true') 
                .end(); 
...
function service(data) {
    ...
    .fcall( () => {
        ...
        return [params, models[params.model].update(params.updateData, {where: params.updateCondition})];
    })
    .spread( (params, updatedModel) => {
        d.resolve(updatedModel);
    })
    .catch( e => {
