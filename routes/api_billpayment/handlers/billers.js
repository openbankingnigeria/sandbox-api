...
vinfo.routeConfig = {};
vinfo.routeConfig.path = "/billers"; //no param customer id will be inferred from the header token passed
vinfo.routeConfig.method = "get"; 
vinfo.routeConfig.middlewares = [routemeta('billpayment_billers', 'dev')];
