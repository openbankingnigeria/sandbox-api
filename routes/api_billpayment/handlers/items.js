...
const service = require('mlar').mreq('services', 'billpayment/search_item');
...
vinfo.routeConfig = {};
vinfo.routeConfig.path = "/biller/:billerId(\\d+)/items"; //no param customer id will be inferred from the header token passed
vinfo.routeConfig.method = "get"; 
vinfo.routeConfig.middlewares = [routemeta('billpayment_items', 'dev')];
