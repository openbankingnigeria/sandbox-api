...
const service = require('mlar').mreq('services', 'billpayment/search_system');
...
vinfo.routeConfig = {};
vinfo.routeConfig.path = "/systems"; //no param customer id will be inferred from the header token passed
vinfo.routeConfig.method = "get"; 
vinfo.routeConfig.middlewares = [routemeta('billpayment_systems', 'dev')];
