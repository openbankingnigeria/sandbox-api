...
const service = require('mlar').mreq('services', 'performance/search');
const routemeta = require('mlar')('routemeta');
function vinfo(req, res, next){ 
        const service_data = {...req.body, ...req.query, ...req.params, ...req.headers};
...
vinfo.routeConfig = {};
vinfo.routeConfig.path = "/metrics"; 
vinfo.routeConfig.method = "get"; 
vinfo.routeConfig.middlewares = [routemeta('meta_performance', 'dev')];
