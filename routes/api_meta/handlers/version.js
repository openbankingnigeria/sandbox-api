...
const service = require('mlar').mreq('services', 'apiversion/search');
const routemeta = require('mlar')('routemeta');
function vinfo(req, res, next){ 
        req.excludes = ['bankId'];
        const service_data = {...req.body, ...req.query, ...req.headers, exclude: {bankId: 1,}};
...
vinfo.routeConfig.middlewares = [routemeta('meta_version', 'dev')];
