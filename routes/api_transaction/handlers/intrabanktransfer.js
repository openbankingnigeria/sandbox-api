...
function vinfo(req, res, next){ 
        const service_data = {...req.body, ...req.query, ...req.headers, ...req.params, context: 'intra'};
...
vinfo.routeConfig = {};
vinfo.routeConfig.path = "/singletransferwithbank"; 
vinfo.routeConfig.method = "post"; 
vinfo.routeConfig.middlewares = [routemeta('transaction_intrabank_transfer', 'dev')];
