...
vinfo.routeConfig = [{},{}];
vinfo.routeConfig[0].path = "/branch/:branchId"; 
vinfo.routeConfig[0].method = "get"; 
vinfo.routeConfig[0].middlewares = [routemeta('pos_branch', 'dev')];

vinfo.routeConfig[1].path = "/merchant/:merchantId"; 
vinfo.routeConfig[1].method = "get"; 
vinfo.routeConfig[1].middlewares = [routemeta('pos_merchant', 'dev')];
