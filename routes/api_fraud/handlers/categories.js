...
const service = require('mlar').mreq('services', 'fraud/categories');
...
vinfo.routeConfig = {};
vinfo.routeConfig.path = "/categories"; 
vinfo.routeConfig.method = "get"; 
vinfo.routeConfig.middlewares = [routemeta('fraud_categories', 'dev')];
