...
const service = require('mlar').mreq('services', 'accountype/search');
const routemeta = require('mlar')('routemeta');
function vinfo(req, res, next){ 
        const service_data = {...req.body, ...req.query, ...req.headers, ...req.params, fetch_one: 1};
...
vinfo.routeConfig = {};
vinfo.routeConfig.path = "/types/:id"; //no param customer id will be inferred from the header token passed
vinfo.routeConfig.method = "get"; 
vinfo.routeConfig.middlewares = [routemeta('get_account_type', 'dev')];
