...
const service = require('mlar').mreq('services', 'account/search');
...
vinfo.routeConfig = {};
vinfo.routeConfig.path = "/"; //no param customer id will be inferred from the header token passed
vinfo.routeConfig.method = "get"; 
vinfo.routeConfig.middlewares = [routemeta('account_all', 'user')];
